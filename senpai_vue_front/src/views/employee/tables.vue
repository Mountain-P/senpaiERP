                        ...
                        <v-col cols="6" sm="12" md="6">
                          <v-menu v-model="datePicker" :close-on-content-click="false" :nudge-right="40"
                            ...
                            <template v-slot:activator="datePickerBind">
                              <v-text-field v-model="editedItem.birthday" label="生日" readonly
                                v-bind="datePickerBind.attrs" v-on="datePickerBind.on"></v-text-field>
                            </template>
                            <v-date-picker v-model="editedItem.birthday" @input="datePicker = false"></v-date-picker>
                          </v-menu>
                        </v-col>
                        <v-col cols="12" sm="12" md="12">
                          <v-text-field v-model="editedItem.baseSalary" label="底薪"></v-text-field>
                        </v-col>
                        <v-col cols="6" sm="12" md="6">
